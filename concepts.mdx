...
Resources are concrete implementations of blueprints within your ecosystem. Each resource is customizable while maintaining the standards defined by its blueprint, including properties, relations, and plugin configurations. Resources must be connected to a Git repository, either directly or inherited from their project.
