...
Amplication offers two distinct ways to create templates, giving you flexibility in how you standardize your resources:

- **Templates from Services:** These templates capture the specific configurations and standards of an existing Amplication service. When you create a resource from a service-based template, you use Amplication's built-in opinionated approach, particularly when the original service uses the Node.js or .NET code generator.
- **Templates from Blueprints:** Templates can also be created from Blueprints. This allows you to capture and reuse the broader organizational standards and configurations defined within a Blueprint for quicker instantiation of resources adhering to those guidelines.

<Note>
To learn about the specifics of templates and their various functionalities, explore the [Live Templates](/day-zero/live-templates) page.
</Note>
...
<Steps>
    <Step title="Project and Template Selection">
        ...
        <p>Select the desired **template** from the dropdown. You can choose from templates created from either existing services or blueprints.</p>
    </Step>
...
After creating your resource from a template, you'll be automatically taken to its resource overview page. The available tabs and settings will depend on whether the template was based on a service or a blueprint.
...
<Info>
For a detailed understanding of how to define your service's API, visit the [Custom Types and Actions](/day-one/custom-types-and-actions/) page.
</Info>

### Entities

In the **Entities** tab, you can [create and manage your data models](/day-one/entities-fields), including defining fields, relationships, and more. This tab is available when the template is based on a service.
...
<Info>
Learn more about how to manage technical debt in the [Technical Debt Management](/day-two/resolve-debt-across-multiple-resources) documentation.
</Info>
...
<Tip>
Within the **Settings** tab, you'll find sub-tabs such as **Resource Configuration**, **APIs & Admin UI**, **Base Directories**, **Authentication Entity**, and **Code Generator Version** (if the template is based on a service), allowing for granular control over your resource's behavior. Refer to the specific documentation for each of these sub-tabs for more information.
</Tip>
