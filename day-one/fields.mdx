...
Each entity is composed of fields which define the attributes of that entity, such as name, email, or price. This page will guide you through creating and configuring entity fields and relationships within Amplication.
...
<Note>
Refer to <a href="https://www.prisma.io/docs/reference/api-reference/prisma-schema-reference#attributes">Prisma's documentation on field attributes</a> for a comprehensive list of available attributes and functions.
</Note>
