...
<Note>
The **Upload Schema** feature is available when using the **.NET** or **Node.js** blueprints in Amplication.
</Note>
...
<Warning>
Always back up your database before performing introspection or migrations.
</Warning>
