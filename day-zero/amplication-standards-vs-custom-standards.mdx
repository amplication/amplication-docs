...
<CardGroup cols={2}>
  <Card title="Built-in Standards" icon="gear">
    Amplication's pre-configured, opinionated engines for Node.js and .NET
  </Card>
  <Card title="Custom Standards" icon="code">
...
<Tip>
  ...
  that use your own custom resources and also resources that use Amplictation's
  built-in standards.
</Tip>
...
<CardGroup cols={2}>
  <Card title="Plugin Library" icon="plug" href="/day-one/use-plugins">
    Access a rich catalog of plugins for authentication, logging, and other
    common functionalities
  </Card>
  <Card title="API Management" icon="code" href="/day-one/custom-types-actions">
    Built-in generation of REST and GraphQL endpoints with automatic DTO
    handling
  </Card>
  <Card title="Data Modeling" icon="database" href="/day-one/entities">
    Automatically generate and manage database schemas, models, and
    relationships
  </Card>
  <Card
...
<CardGroup cols={2}>
  ...
  >
    Define your own architecture patterns and resource templates with custom
    configurations
  </Card>
  <Card title="Private Plugins" icon="plug" href="/day-zero/private-plugins">
    Build custom plugins to generate code for custom authentication, data
    models, and integrations that matches your organization's standards
  </Card>
  <Card
  ...
  >
    Establish golden paths for your development teams with pre-configured
    templates
  </Card>
  <Card
