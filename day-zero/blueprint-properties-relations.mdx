...
- **Create Meaningful Connections**  
  ...
  This helps your team understand and navigate a complex ecosystem with clarity and can be used to generate context-aware code and keep consistent settings across services.
...
<AccordionGroup>
  ...
  <Accordion icon="circle-3" title="Set the Relation Scope">
  ...
  <Accordion icon="circle-4" title="Generate Dynamic Code with Plugins">
...
<Steps>
  <Step title="Security & Compliance by Default" icon="shield-halved">
    ...
    <Frame>
      <img src="/images/day-zero/blueprint-relation-example-1.png" />
    </Frame>
  </Step>
  ...
  <Step title="Auto-Connect Frontend & Backend" icon="object-group">
    ...
    <Frame>
      <img src="/images/day-zero/blueprint-relation-example-2.png" />
    </Frame>
  </Step>
  ...
  <Step title="Streamlined Infrastructure Setup" icon="server">
   ...
   <Frame>
      <img src="/images/day-zero/blueprint-relation-example-3.png" />
    </Frame>
