...
<Note>
Blueprints support [Properties and Relations](/day-zero/blueprint-properties-relations) for modeling complex architectures.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/day-zero/blueprint-properties-relations#blueprint-relations"
  >
