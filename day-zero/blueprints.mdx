...
<Card title="Accelerate Development" icon="rocket">
  Provide teams with pre-configured, ready-to-run templates that incorporate
  your best practices, allowing developers to focus on business logic.
</Card>

<Card title="Maintain Consistency" icon="arrows-repeat">
  Create a single source of truth for your architecture, including service
  definitions, properties, and relationships between different components.
</Card>
...
<Note>
  Blueprints support [Properties and
  Relations](/day-zero/blueprint-properties-relations) for modeling complex
  architectures.
</Note>
