...
<Frame>
    <img src="/images/day-zero/catalog-with-catalog-properties.png" />
</Frame>
...
As a platform team, you need to ensure that every new or existing resource in your software ecosystem follows your organization’s best practices, security requirements, and architectural standards.
...
Catalog Properties are available in the following types:
...
<Steps>
  ...
  <Step title="Monitored Regions" icon="map-pin">
     Specify the geographic regions where a service is actively monitored for performance and compliance, allowing for comprehensive oversight across your infrastructure.
    <Frame>
        <img src="/images/day-zero/catalog-property-example-2.png" />
    </Frame>
  </Step>

  <Step title="CRON Schedule" icon="calendar">
    Define and validate the CRON expressions for scheduled jobs.
    ...
    <Step title="Documentation Link" icon="book">
      Define and validate a link to a specific documentation site.
...
<Steps>
  ...
  <Step title="Navigate to 'Catalog Properties'">
