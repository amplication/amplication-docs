...
<Note>
For detailed technical information about implementing plugins, visit our [Plugin Development Guide](/plugin-development).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Plugin Folder Structure" icon="folder-tree" href="/plugin-development/plugin-folder-structure">
