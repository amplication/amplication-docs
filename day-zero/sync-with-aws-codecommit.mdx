...
<Note>
Please [contact Amplication](mailto:support@amplication.com) to provide your AWS credentials and region information before attempting to connect your AWS CodeCommit account.
