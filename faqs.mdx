...
Blueprints are like architectural drawings that define what you want to build - they specify the type of resource, its properties, and relationships with other blueprints. Think of them as basic models that standardize what you build across your organization.
...
They ensure you can generate the code based on your organization's own standards and requirements.
...
Blueprint updates are not automatically propagated to existing resources - this is intentional to prevent unexpected disruptions. After you update a Blueprint (e.g. add a property, or a relation), you'll need to manually set the values for these changes per each resource.
...
<Note>Learn more about how Amplication manages code generation and Git repos in our [Smart Git Sync guide](day-zero/smart-git-sync).</Note>
</Accordion>
